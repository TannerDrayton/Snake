...
class Snake():
    ...
    def show(self):
        for body_part in self.body:
            pygame.draw.rect(game_display, SNAKE_COLOR, pygame.Rect(
                body_part[0], body_part[1], BLOCK_SIZE, BLOCK_SIZE))
...
class Apple():
    ...
    def show(self):
        pygame.draw.rect(game_display, APPLE_COLOR, pygame.Rect(
            self.xcor, self.ycor, BLOCK_SIZE, BLOCK_SIZE))
